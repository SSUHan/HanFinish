...
public class CalendarMonthAdapter extends BaseAdapter {
	...
	TimeTableActivity act = new TimeTableActivity();
	Context mContext;

	public static int oddColor = Color.rgb(225, 225, 225);
	public static int headColor = Color.rgb(12, 32, 158);

	ListViewActivity list = new ListViewActivity();
...
//		act.screenHeight = metrics.heightPixels;
	...
	public int setDayChangedMonth(MonthItem item, int position) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		CalendarMonthViewActivity monthAct = new CalendarMonthViewActivity();
		...
		if (CalendarMonthViewActivity.changing == 1
				&& position == CalendarMonthViewActivity.mPosition
				&& curMonth == CalendarMonthViewActivity.selectedMonth) {
