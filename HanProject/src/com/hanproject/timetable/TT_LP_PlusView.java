...
public class TT_LP_PlusView extends LinearLayout {
	
	
	Button deleteBtn;
	TT_LP_ListViewData aItem;
	Context context;
	int position;
    ...
    public TT_LP_PlusView(Context mcontext,TT_LP_ListViewData bItem) 
    {
    	super(mcontext);
    ...
    public void inflate()
    {
        ...
        inflater.inflate(R.layout.lp_plus, this, true);
    }
	...
	public void setView(int pos) {
        ...
        final OnTimeSetListener listener1 = new OnTimeSetListener() {		
        	...
        	public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
        		aItem.start.setText(hourOfDay+":"+numberTwo(minute));
        		aItem.setStartTime(hourOfDay+":"+numberTwo(minute));
        	}
        	};
        ...
        final OnTimeSetListener listener2 = new OnTimeSetListener() {		
        	@Override
        	public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
        		aItem.finish.setText(hourOfDay+":"+numberTwo(minute));
        		aItem.setFinishTime(hourOfDay+":"+numberTwo(minute));
        	}
        	};
        ...
        aItem.deleteBtn.setOnClickListener(new OnClickListener(){
    			...
    			public void onClick(View v) {
    				...
    				TT_LP_MainActivity.adapter.deleteItem(position);
    
    						
    				TT_LP_MainActivity.adapter.notifyDataSetChanged();
    				
    				TT_LP_MainActivity.deleteLisetViewHeight(TT_LP_MainActivity.plus,
    						TT_LP_MainActivity.adapter.getCount());
